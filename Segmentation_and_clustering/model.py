...
img_size = (256,256,48) # 256 * 256 grayscale img with 1 channel
...
def unet(pretrained_weights = None,input_size = img_size):
    ...
    #model.compile(optimizer = Adam(lr = learning_rate, decay = learning_decay_rate, beta_1=0.09, beta_2=0.0999), loss=total_loss, metrics=metrics)
